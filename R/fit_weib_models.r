...
#' @param x Dataframe with columns names Height (consisting of measured heights), Diameter (measured diameters) and WD (wood density). These will be present if an object return by \code{\link{mergefp}} is used.
